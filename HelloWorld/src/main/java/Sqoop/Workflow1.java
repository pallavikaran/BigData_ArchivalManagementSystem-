...
public class Workflow1 {
	   ...
	   public boolean createWorkflowXML(ClusterConnectionFormBean objClusterConnectionFormBean) {
	      ...
	      try {
	         ...
	         String username=objUtilityDAO.getSingleColumnValues("metadata_store", " username ", "connection_string='"+ConnectionStringFromSelectionPage+"'");
	         System.out.println("username "+username);
	         String passsword=objUtilityDAO.getSingleColumnValues("metadata_store", " password ", "connection_string='"+ConnectionStringFromSelectionPage+"'");
